...
fn problem11() {
    ...
    for mut x in 3..20 {
        ...
        // get sliding window of 4.
        let for1 = diagonal_for1.windows(4);
        let for2 = diagonal_for2.windows(4);
        let diag1 = diagonal_bak1.windows(4);
        let diag2 = diagonal_bak2.windows(4);
        //for1.product()
